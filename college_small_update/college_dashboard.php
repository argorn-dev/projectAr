...
<h5 class="bg-white text-success text-center" >KNUST COLLEGE VOTING</h5>
  ...
  <div class="dropdown-container">
    ...
    <a href="view_students.html" target="display">**View Students</a>
      <hr style="border-bottom: 1px solid green; margin-top:30px; margin-right: 5px;  margin-left: 5px" >
...
<div id="main">
  <div style="margin-left: 0%; padding: 2%">
  		<iframe width="100%" height="700" src="welcome.html" src="login.html" src="home.html" style="border-style: none;border-top: 2px solid green;" class="" name="display">	
