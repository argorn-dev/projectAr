...
<br>
  ...
  <select>
    <option>
      ...
      <p style="font-family: Arial; font-size: 18px; color:green;"><strong> Welcome <?php echo $_SESSION['index_number']; ?></strong></p></option>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="nav nav-pills nav-justified">
      <li class="nav-item">
        ...
        <a class="nav-link" href="#"><i class="fas fa-vote-yea"></i>+Polls</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><i class="fas fa-poll"></i></i>Ongoing Poll</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index.php"><i class="fas fa-sign-out-alt"></i> +/- Membership</a>
      </li>
    </ul>
  </div>
</nav>
...
<h3> Hello,
<?php  if (isset($_SESSION['index_number'])) : ?>
     <strong><?php echo $_SESSION['index_number']; ?></strong>
      <?php endif ?>
</h3>
...
<!-- <footer class="bg-success justify-content-center" style="top: 0; position: relative;">
