...
<br>
  ...
  <!-- Brand -->
  <a style="font-family: arial;" class="navbar-brand" >MANAGE POLL</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="nav nav-pills nav-justified">
      <li class="nav-item">
        ...
        <a class="nav-link" href="select_election.php"><i class="fas fa-fist-raised"></i> Create A Poll </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><i class="fas fa-poll-h"></i> Edit/Delete Poll</a>
      </li>
