...
<br>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="nav nav-pills nav-justified">
      ...
      <li class="nav-item">
        <a class="nav-link" href="register.php"><i class="fas fa-user-plus"></i></i> SignUp</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="head_login.php"><i class="fas fa-users-cog"></i> College Head </a>
      </li>
    </ul>
  </div>
</nav>
