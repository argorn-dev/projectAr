...
<div class="alert alert-info">
 Click on <strong>"Create Poll"</strong> down below to create Poll After Registering Candidates!!
</div>
<hr>
<div class="container">
  <div class="container">
...
<div class="alert alert-success">
 Click on <strong>"Create Poll"</strong> down below to create Poll After Registering Candidates!!
    ...
    <button type="submit" class="btn btn-success" name="submit_poll">Create Poll</button>
</div>
